...
class VariantFactory {
    ...
    createSizeVariant(values = VariantFactory.STANDARD_VARIANTS[VariantType_1.VariantType.SIZE.value]) {
        return Variant_1.Variant.createSizeVariant(values);
    }
    createIntentVariant(values = VariantFactory.STANDARD_VARIANTS[VariantType_1.VariantType.INTENT.value]) {
        return Variant_1.Variant.createIntentVariant(values);
    }
    createToneVariant(values = VariantFactory.STANDARD_VARIANTS[VariantType_1.VariantType.TONE.value]) {
        return Variant_1.Variant.createToneVariant(values);
    }
    createEmphasisVariant(values = VariantFactory.STANDARD_VARIANTS[VariantType_1.VariantType.EMPHASIS.value]) {
...
//# sourceMappingURL=VariantFactory.js.map