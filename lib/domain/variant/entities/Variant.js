...
class Variant {
    ...
    static createSizeVariant(values) {
        return new Variant(VariantType_1.VariantType.SIZE, values);
    }
    static createIntentVariant(values) {
        return new Variant(VariantType_1.VariantType.INTENT, values);
    }
    static createToneVariant(values) {
        return new Variant(VariantType_1.VariantType.TONE, values);
    }
    static createEmphasisVariant(values) {
        return new Variant(VariantType_1.VariantType.EMPHASIS, values);
    }
    // Getters
    get type() {
        return this._type;
