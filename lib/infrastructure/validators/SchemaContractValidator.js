...
class SchemaContractValidator {
    ...
    async validate(contract, context) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateThemeContractRules(contract, errors, warnings) {
     ...
     */
    validateSkinContractRules(contract, errors, warnings) {
     ...
     */
    validateUtilityContractRules(contract, errors, warnings) {
     ...
     */
    validateVariantCompatibility(contract, errors, warnings) {
