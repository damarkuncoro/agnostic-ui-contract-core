 ...
 */
function validatePackageStructure(contractPath, errors, warnings) {
    const requiredFiles = [
        'package.json',
        'tsconfig.json',
        'README.md',
 ...
 */
function validatePackageJson(contractPath, errors, warnings) {
 ...
 */
function validateTypeScriptFiles(contractPath, errors, warnings) {
    const srcPath = path.join(contractPath, 'src');
    if (!fs.existsSync(srcPath)) {
        return;
    }
 ...
 */
function validateSemanticArrays(contractPath, errors, warnings) {
    const srcPath = path.join(contractPath, 'src');
    if (!fs.existsSync(srcPath)) {
        return;
    }
 ...
 */
function validateExports(contractPath, errors, warnings) {
 ...
 */
function validateDocumentation(contractPath, errors, warnings) {
