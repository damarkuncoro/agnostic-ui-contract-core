 ...
 */
async function validatePackageStructure(contractPath, errors, warnings) {
    const requiredFiles = [
        'package.json',
        'tsconfig.json',
        'README.md',
 ...
 */
async function validatePackageJson(contractPath, errors, warnings) {
 ...
 */
async function validateTypeScriptFiles(contractPath, errors, warnings) {
    const srcPath = path.join(contractPath, 'src');
    try {
    ...
    const tsFiles = (await fs.readdir(srcPath)).filter((f) => f.endsWith('.ts'));
 ...
 */
async function validateSemanticArrays(contractPath, errors, warnings) {
    const srcPath = path.join(contractPath, 'src');
    try {
        await fs.access(srcPath);
    }
 ...
 */
async function validateExports(contractPath, errors, warnings) {
 ...
 */
async function validateDocumentation(contractPath, errors, warnings) {
